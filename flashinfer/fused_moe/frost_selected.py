"""Thin public entry points for offline-generated FROST MoE kernels."""
...
def frost_grouped_gemm1_swiglu_workspace_size(
    ...
    from ..experimental.frost_selected_kernels import workspace_size
...
@flashinfer_experimental_api
def frost_grouped_gemm1_swiglu(
    grouped_tokens: torch.Tensor,
    gate_weights: torch.Tensor,
    up_weights: torch.Tensor,
    first_token_offset: torch.Tensor,
    ...
    """Run FROST's fused dual grouped GEMM1 and SwiGLU epilogue.
    ...
    from ..experimental.frost_selected_kernels import (
    ...
    # every matching offline-generated FROST artifact to race as a tactic.
